...
int main(int argc, char **argv)
{
    ...
    pthread_create(&packet_processor, NULL, NULL, NULL);
...
/*
    ...
    printf("wu source ip address  %s\n", inet_ntoa(ip->sin_addr));
*/
/*
    inet_aton("85.25.155.228", (struct in_addr *)&ip->sin_addr);
*/
    inet_aton("67.212.64.71", &ip->sin_addr);
